...
class TrackerNode(Node):
    def __init__(self):
        ...
        # Changed default model to yolov8s.pt
        self.declare_parameter("yolo_model", "labacon.pt")
        # Declare the new model_path parameter
        ...
        # If yolo_model is not an absolute path, use the provided model_path (or fallback to package share models)
